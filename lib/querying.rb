...
def select_series_title_with_most_human_characters
  "SELECT Series.title FROM Series INNER JOIN Characters ON Series.id = Characters.series_id COUNT(Characters.speices) FROM Characters GROUP BY species WHERE species = 'human';"
end
